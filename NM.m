%Nelder and Mead simplex algoritmas
clear 
clc
...
for K=1:maxiter %%%%%%%%%%%%%%%-Will be returned if a corner is constant for m times.-%%%%%%
    ...
    for KK=1:maxiter %%%%%%%%%%%%%%%-Will be continue here if the corners are changing-%%%%%%
        %% 3- Findings
        F=zeros(1,n+1);
        for i=1:n+1
            F(i)=f(x(:,i));
